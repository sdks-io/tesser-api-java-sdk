...
|  --- | --- | --- | --- | --- | --- |
| `Data` | [`List<Data7>`](../../doc/models/data-7.md) | Required | - | List<Data7> getData() | setData(List<Data7> data) |
| `Pagination` | [`Pagination`](../../doc/models/pagination.md) | Optional | Pagination details | Pagination getPagination() | setPagination(Pagination pagination) |
